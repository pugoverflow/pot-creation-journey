...
export default function HomePage() {
  ...
  return (
    <main className="mx-auto flex w-full max-w-[1200px] flex-col gap-6">
      ...
      >
        <h1 id="hero-heading" className="type-h1">
      ...
      >
        <div className="flex flex-1">
          <div className="flex w-full flex-col gap-[14px] rounded-[20px] border border-[var(--color-grey-94)] bg-white p-6 shadow-[0px_4px_24px_0px_#1E1B4B0F]">
