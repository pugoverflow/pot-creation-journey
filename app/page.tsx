  ...
  return (
    <main>
      <div>
        ...
        <p>Organise the things you love with the people you love - without getting stuck with the bill.</p>
      </div>

      <div>
        <h5>What are you collecting for?</h5>
        {/* The user must select a Category representing what they are collecting money for. */}
